...
public class RefundDetail {
    ...
    public static class RefundDetailInfo{
        ...
        private List<RefundDetailProductList> ProductList;
        ...
        public List<RefundDetailProductList> getProductList() {
            return ProductList;
        }

        public void setProductList(List<RefundDetailProductList> productList) {
            ProductList = productList;
        }

        public static class RefundDetailProductList{
            /**"ProductID": "11",
