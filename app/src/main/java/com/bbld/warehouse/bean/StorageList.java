...
public class StorageList {
    ...
    private int status;
    private String mes;
    private List<StorageListList> list;
    ...
    public List<StorageListList> getList() {
        return list;
    }

    public void setList(List<StorageListList> list) {
        this.list = list;
    }

    public static class StorageListList{
        /**"StorageID": "29",
        ...
        public List<StorageListProductList> getProductList() {
            return ProductList;
        }

        public void setProductList(List<StorageListProductList> productList) {
            ProductList = productList;
        }

        public static class StorageListProductList{
            /**"ProductID": "11",
             "ProductName": "商品名称",
