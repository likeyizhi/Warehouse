...
public class THRKActivity extends BaseActivity{
    ...
    private List<RefundGetHQRefundList.RefundGetRefundListlist> list;
    ...
    private void setListeners() {
        ibBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityManagerUtil.getInstance().finishActivity(THRKActivity.this);
            }
        });
    ...
    private void loadData(final boolean isLoadMore) {
        Call<RefundGetHQRefundList> call= RetrofitService.getInstance().refundGetHQRefundList(token,page,pagesize);
        call.enqueue(new Callback<RefundGetHQRefundList>() {
            @Override
            public void onResponse(Response<RefundGetHQRefundList> response, Retrofit retrofit) {
                if (response==null){
                ...
                if (response.body().getStatus()==0){
                    if (isLoadMore){
                        List<RefundGetHQRefundList.RefundGetRefundListlist> listAdd = response.body().getList();
                        list.addAll(listAdd);
    ...
    class THRKAdapter extends BaseAdapter {
        ...
        @Override
        public RefundGetHQRefundList.RefundGetRefundListlist getItem(int i) {
            return list.get(i);
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            final RefundGetHQRefundList.RefundGetRefundListlist item = getItem(i);
            ...
            holder.btn_scan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Bundle bundle=new Bundle();
                    bundle.putString("id", item.getId()+"");
                    readyGo(THRKRKActivity.class,bundle);
                }
            });
            return view;
        }
