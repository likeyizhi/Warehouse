...
/**
 * 其他入库
 * Created by likey on 2017/8/25.
 */

public class PendingInActivity extends BaseActivity{
    ...
    private List<QTInStorageList.PendingOutStorageListList> storageList;
    ...
    private void setListeners() {
        ibBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityManagerUtil.getInstance().finishActivity(PendingInActivity.this);
            }
        });
    ...
    private void loadData(final boolean isLoadMore) {
        Call<QTInStorageList> call= RetrofitService.getInstance().getQTInStorageList(token,page,pagesize);
        call.enqueue(new Callback<QTInStorageList>() {
            @Override
            public void onResponse(Response<QTInStorageList> response, Retrofit retrofit) {
                if (response==null){
                    showToast("数据获取失败");
                    return;
                }
                if (response.body().getStatus()==0){
                    if (isLoadMore){
                        List<QTInStorageList.PendingOutStorageListList> storageListAdd = response.body().getList();
...
//                            llKong.setBackgroundColor(Color.WHITE);
    ...
    class OutBoundAdapter extends BaseAdapter {
        ...
        @Override
        public QTInStorageList.PendingOutStorageListList getItem(int i) {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            final QTInStorageList.PendingOutStorageListList item = getItem(i);
    ...
    public int getContentView() {
        return R.layout.activity_pending_in;
    }
}
