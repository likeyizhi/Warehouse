...
import com.bbld.warehouse.scancodenew_hhrk.scan.CaptureActivity;
...
public class HHRKRKActivity extends BaseActivity{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 111:
                    ...
                    ActivityManagerUtil.getInstance().finishActivity(HHRKRKActivity.this);
                    break;
                case 222:
                    WeiboDialogUtils.closeDialog(baocunDialog);
                    btnSubmit.setClickable(true);
    ...
    protected void initViewsAndEvents() {
        mUserSQLiteOpenHelper = UserSQLiteOpenHelper.getInstance(HHRKRKActivity.this);
    ...
    private void initAppList(){
        loading=WeiboDialogUtils.createLoadingDialog(HHRKRKActivity.this,"加载中...");
        new Thread(){
            @Override
            public void run() {
                super.run();
                //扫描得到APP列表
                appInfos = ApkTool.scanLocalInstallAppList(HHRKRKActivity.this.getPackageManager());
    ...
    private void setListeners() {
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                baocunDialog= WeiboDialogUtils.createLoadingDialog(HHRKRKActivity.this,getString(R.string.caozuo_ing));
...
//                showToast(jsonString);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            request= UploadUserInformationByPostService.givebackReceiveGiveback(new MyToken(HHRKRKActivity.this).getToken()+"", id);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                ...
                private void toScan(String productID, String productName, int type, String productCount) {
                    if (Build.VERSION.SDK_INT >= 23){
                        ...
                        if (cameraPermission != PackageManager.PERMISSION_GRANTED){
                            ActivityCompat.requestPermissions(HHRKRKActivity.this, new String[]{Manifest.permission.CAMERA}, 123);
                            return;
                        }else{
                            Bundle bundle=new Bundle();
    ...
    private void showBackDialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(HHRKRKActivity.this);
    ...
    public int getContentView() {
        return R.layout.activity_hhrk_rk;
    }
}
