...
public class HHCKInfoMxActivity extends BaseActivity{
    ...
    private void setListeners() {
        ibBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityManagerUtil.getInstance().finishActivity(HHCKInfoMxActivity.class);
            }
        });
    }

    private void loadData() {
        loading= WeiboDialogUtils.createLoadingDialog(HHCKInfoMxActivity.this,"加载中...");
        Call<RefundGetRefundProductScanCode> call= RetrofitService.getInstance().givebackGetGivebackScanCode(token, id, productId);
