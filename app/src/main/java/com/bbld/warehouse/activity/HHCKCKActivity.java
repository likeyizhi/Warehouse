...
import com.bbld.warehouse.scancodenew_hhck.scan.CaptureActivity;
...
public class HHCKCKActivity extends BaseActivity{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 111:
                    ...
                    ActivityManagerUtil.getInstance().finishActivity(HHCKCKActivity.this);
                    break;
                case 222:
                    WeiboDialogUtils.closeDialog(baocunDialog);
                    btnSubmit.setClickable(true);
    ...
    protected void initViewsAndEvents() {
        mUserSQLiteOpenHelper = UserSQLiteOpenHelper.getInstance(HHCKCKActivity.this);
    ...
    private void initAppList(){
        loading=WeiboDialogUtils.createLoadingDialog(HHCKCKActivity.this,"加载中...");
        new Thread(){
            @Override
            public void run() {
                super.run();
                //扫描得到APP列表
                appInfos = ApkTool.scanLocalInstallAppList(HHCKCKActivity.this.getPackageManager());
    ...
    private void setListeners() {
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                baocunDialog= WeiboDialogUtils.createLoadingDialog(HHCKCKActivity.this,getString(R.string.caozuo_ing));
...
//                showToast(jsonString);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            request= UploadUserInformationByPostService.givebackCommitGiveback(new MyToken(HHCKCKActivity.this).getToken()+"",
                                    id,uuid,codejson);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    class THSQInfoAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (info.getReturnStatus()==1){
                holder.btn_toScan.setVisibility(View.VISIBLE);
            }else{
                holder.btn_toScan.setVisibility(View.GONE);
            }
            ...
            holder.btn_toScan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (is_iData){
                        ...
                        readyGo(IDataScanHHCKActivity.class, bundle);
                    }else{
                ...
                private void toScan(String productID, String productName, int type, String productCount) {
                    if (Build.VERSION.SDK_INT >= 23){
                        ...
                        if (cameraPermission != PackageManager.PERMISSION_GRANTED){
                            ActivityCompat.requestPermissions(HHCKCKActivity.this, new String[]{Manifest.permission.CAMERA}, 123);
                            return;
                        }else{
                            Bundle bundle=new Bundle();
    ...
    private void showBackDialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(HHCKCKActivity.this);
    ...
    private void cleanAll() {
        Call<ClearScanCode> clearCall=RetrofitService.getInstance().clearScanCodeRefund(new MyToken(HHCKCKActivity.this).getToken(),uuid);
    ...
    public int getContentView() {
        return R.layout.activity_hhck_ck;
    }
}
